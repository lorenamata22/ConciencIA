...
function BookIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="16" height="19" viewBox="0 0 16 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.4111 0.100403C14.9014 0.100624 15.2996 0.494102 15.2998 0.982239V13.9061C15.2998 14.0046 15.274 14.125 15.2363 14.2352C15.1987 14.3452 15.1453 14.4569 15.083 14.5359C14.4261 15.3663 14.4261 16.5338 15.083 17.3641C15.3847 17.7451 15.1093 18.2995 14.625 18.2996H2.46973C1.16215 18.2995 0.100599 17.2484 0.100586 15.95V3.7215C0.100673 1.72073 1.73686 0.100403 3.75293 0.100403H14.4111ZM2.46973 14.5828C1.70707 14.5829 1.08988 15.1961 1.08984 15.95C1.08984 16.704 1.70704 17.3172 2.46973 17.3172H13.9043C13.5038 16.454 13.5015 15.4577 13.8984 14.5936H10.166V14.5828H2.46973ZM3.75293 1.08282C2.28179 1.08282 1.09007 2.2652 1.08984 3.7215V14.0399C1.47861 13.7632 1.9552 13.6004 2.46973 13.6004H14.3105V1.08282H3.75293ZM3.55566 3.03497C3.828 3.03516 4.0498 3.25406 4.0498 3.52618V11.5477C4.0498 11.8198 3.828 12.0387 3.55566 12.0389C3.28317 12.0389 3.06055 11.8199 3.06055 11.5477V3.52618C3.06055 3.25394 3.28317 3.03497 3.55566 3.03497Z" fill="currentColor" stroke="currentColor" strokeWidth="0.2"/>
    </svg>
...
const NAV_SECTIONS_MENU: NavSection[] = [
  {
    ...
    items: [
      ...
      { name: 'Archivos',    href: '/teacher/files', Icon: FolderIcon,     roles: ['teacher'] },
      { name: 'Tareas',        href: '/teacher/tasks',     Icon: ClipboardIcon,  roles: ['teacher'] },
      { name: 'Documentación', href: '/teacher/documentation', Icon: FileTextIcon, roles: ['teacher'] },
      ...
      { name: 'Clases',      href: '/institution/classes',  Icon: UsersIcon,      roles: ['institution'] },
      { name: 'Archivos',    href: '/institution/files',    Icon: FolderIcon,     roles: ['institution'] },
