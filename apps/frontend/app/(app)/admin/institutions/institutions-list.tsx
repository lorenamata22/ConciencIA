        ...
        <table className="w-full table-fixed min-w-[640px]">
          ...
          <thead>
            <tr>
              ...
              <th scope="col" className="px-4 pt-3 pb-8 text-xs font-semibold text-brand-label tracking-wide uppercase text-left">Estado</th>
            ...
            {paginated.length === 0 ? (
              ...
              paginated.map((inst) => (
                <tr
                  ...
                  className="cursor-pointer hover:bg-brand-border/10 transition-colors"
                >
                  <td className="pl-6 pr-4 py-4 border-t border-brand-border max-w-0">
                    <span className="block truncate text-sm font-medium text-brand-brown">{inst.name}</span>
                  </td>
                  <td className="px-4 py-4 border-t border-brand-border max-w-0">
                    <span className="block truncate text-sm text-brand-label">{inst.email ?? '—'}</span>
                  </td>
                  <td className="px-4 py-4 border-t border-brand-border">
                    <StatusBadge status={inst.status} />
                  </td>
                  <td className="pl-4 pr-6 py-4 border-t border-brand-border" onClick={(e) => e.stopPropagation()}>
